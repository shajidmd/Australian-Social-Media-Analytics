...
##Twitter search
##------------------------------------------------------------------
APP_KEY='fzAHYFgtcJtbhXShFUN8NPKfi'
APP_SECRET='rMxsgIU50LECPOBGZNrKBQ7l6guOzH2mdJdRmSBpn7oqnycbUX'
...
while loop:
    for keyword in keywords:
        try:
            string='#'+keyword+' '
            t=twitter.search(q=string,count=MAX_COUNT, lang='en', geocode=GEO_CODE1)
            time.sleep(6)
