...
consumer_key = "xY76W1ISiAMeRsF7m3OvQgn7b"
consumer_secret = "tUkGcGMAfGTJCN8kduhMpcObU0ctXd4r209hzFrZiAjjadjc5h"
access_key = "1182567540-XAe1M0DHb6ZJAQrLNvgFcTRD3kBHBd5Djw09kj3"
access_secret = "Em11MP4IrBCLvvJAQQ2gvr90VfrCicbLv5kBkKYAo1YIu"
...
def get_all_tweets(screen_name):
	...
	new_tweets = api.user_timeline(screen_name = screen_name,count=200,lang='en', geocode=GEO_CODE3)
	...
	while len(new_tweets) > 0:
		...
		new_tweets = api.user_timeline(screen_name = screen_name,count=MAX_COUNT,max_id=oldest,lang='en', geocode=GEO_CODE3)
