...
##Twitter search
##------------------------------------------------------------------
APP_KEY='z4u6BwVCcMgWyyP1XY1BkgRfo'
APP_SECRET='G89HAaLfIpZpr2AM8KohDvGJzTYt181OQBLCwFDpbK8hbBJhLB'
...
while loop:
    for keyword in keywords:
        try:
            string='#'+keyword+' '
            t=twitter.search(q=string,count=MAX_COUNT, lang='en', geocode=GEO_CODE2)
            time.sleep(6)
