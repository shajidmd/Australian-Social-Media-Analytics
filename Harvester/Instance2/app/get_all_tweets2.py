...
def get_all_tweets(screen_name):
	...
	new_tweets = api.user_timeline(screen_name = screen_name,count=200, lang='en', geocode=GEO_CODE2)
	...
	while len(new_tweets) > 0:
		...
		new_tweets = api.user_timeline(screen_name = screen_name,count=MAX_COUNT,max_id=oldest,lang='en', geocode=GEO_CODE2)
